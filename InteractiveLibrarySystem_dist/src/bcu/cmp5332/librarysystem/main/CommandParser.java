    ...
    public static Command parse(String line) throws IOException, LibraryException {
        try {
            ...
            if (cmd.equals("addbook")) {
                BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); //takes input to add a new book
            	...
            	BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); //takes input to add a new patron
